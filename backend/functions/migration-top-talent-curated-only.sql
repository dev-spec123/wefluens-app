-- migration-top-talent-curated-only.sql
-- Top Talent is now ONLY the admin-curated featured list — no opt-in follower
-- fill. The data_sharing / "Discoverable" toggle no longer affects this list.
-- Run after migration-admin-curation.sql. Idempotent.
